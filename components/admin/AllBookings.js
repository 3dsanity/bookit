...
import { DELETE_BOOKING_RESET } from '../../contexts/constants/bookingConstants';
...
const AllBookings = () => {
  ...
  const {
    dispatch,
    state: {
      bookings: { bookings, error, loading },
      booking: { isDeleted, error: deleteError },
    },
  } = useAppContext();

  useEffect(() => {
    getAdminBookings(dispatch);
